...
struct CardStanceTests {
    ...
    func nearSquareStaysReady() {
        ...
        #expect(almostSquareWide.cardStance == .ready)
    }
    ...
    func emptyBoxIsReady() {
        #expect(CGRect.zero.cardStance == .ready)
    }
